    ...
    <div className="p-6 bg-white rounded-lg shadow-md">
        ...
        {showTitleSuggestions && titleSuggestions.length > 0 && (
          <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg">
            <div className="p-2 border-b border-gray-200 flex justify-between items-center">
              <span className="text-sm font-medium text-gray-700">Suggested titles:</span>
              <button onClick={() => setShowTitleSuggestions(false)} className="text-gray-400 hover:text-gray-600">
                <X size={14} />
              </button>
            </div>
            <div className="p-2">
          ...
          <div className="absolute bottom-2 right-2 w-2/3 bg-white border border-indigo-200 rounded-lg shadow-lg">
            <div className="p-3 border-b border-indigo-100 bg-indigo-50 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <span className="font-medium text-indigo-700">AI Suggestion</span>
              </div>
              <button onClick={() => setAiAssistantOpen(false)} className="text-gray-500 hover:text-gray-700">
                <X size={16} />
              </button>
            </div>
      ...
      {isRecording && (
        <div className="mb-4 p-3 bg-red-50 text-red-600 rounded-md flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span>{isMeetingMode ? 'Recording meeting' : 'Recording audio'}...</span>
          </div>
          {isMeetingMode && (
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <Button 
          ...
          className={`${isRecording ? 'bg-red-600 hover:bg-red-700' : 'bg-blue-600 hover:bg-blue-700'} text-white flex items-center`}
        >
        ...
        <Button 
          ...
          className={`${isMeetingMode ? 'bg-purple-600 hover:bg-purple-700' : 'bg-gray-600 hover:bg-gray-700'} text-white flex items-center`}
        >
